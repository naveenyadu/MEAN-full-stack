...
public class question1 {
	...
	public static void main(String[] args) {
		...
		list.put((long) 1983838484,new Contact("ravi","ravi@gmail.com",g1));
		list.put((long) 1453838444,new Contact("pavani","pavani@gmail.com",g2));
		list.put((long) 1353838444,new Contact("roman","roman@gmail.com",g1));
